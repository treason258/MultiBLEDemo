...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     * treason@20150729
     */
    public void setRefreshingLoadMore() {
        if (!isRefreshing()) {
            mCurrentMode = Mode.PULL_FROM_END;
    ...
    final void setState(State state, final boolean... params) {
        ...
        switch (mState) {
            case RESET:
                // treason@20160118
                long durationTime = System.currentTimeMillis() - mManualRefreshingTime;
                // Log.e("TREASONTEST", "durationTime -> " + durationTime);
            ...
            case MANUAL_REFRESHING:
                ...
                mManualRefreshingTime = System.currentTimeMillis();
                break;
            case OVERSCROLLING:
                // NO-OP
                break;
