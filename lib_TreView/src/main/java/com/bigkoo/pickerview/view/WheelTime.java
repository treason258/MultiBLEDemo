...
public class WheelTime {
    ...
    public void setOnTimeSelectListener(OnTimeChangedListener onTimeChangedListener) {
    ...
    public void onTimeChanged() {
        if (mOnTimeChangedListener != null) {
            try {
                mOnTimeChangedListener.onChanged(WheelTime.dateFormat.parse(getTime()));
            } catch (Exception e) {
                e.printStackTrace();
                mOnTimeChangedListener.onChanged(new Date());
            }
        }
    }
}
